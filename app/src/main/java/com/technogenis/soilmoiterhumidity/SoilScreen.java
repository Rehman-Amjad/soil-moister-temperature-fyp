...
public class SoilScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soil_screen);
        ...
        img_fire_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent=new Intent(SoilScreen.this,DashboardScreen.class);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                value =snapshot.child("SoilTemps").getValue(String.class);
                ...
                tv_moisture.setText("Soil Temperature: " +user.getSoilTemps() + " C");
