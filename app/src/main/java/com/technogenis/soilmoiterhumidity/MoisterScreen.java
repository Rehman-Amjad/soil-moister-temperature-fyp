...
public class MoisterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moister_screen);
        ...
        img_fire_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent=new Intent(MoisterScreen.this,DashboardScreen.class);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                value =snapshot.child("Moistures").getValue(String.class);
                ...
                tv_moisture.setText("Moisture: " +user.getMoistures() + " C");
